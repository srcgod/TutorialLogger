package com.srcgod.shittthax.api.clickgui.component.components;

import java.awt.*;
import java.util.ArrayList;

import com.srcgod.shittthax.api.clickgui.Setting;
import com.srcgod.shittthax.api.clickgui.component.components.sub.Slider;
import com.srcgod.shittthax.api.module.Module;
import com.srcgod.shittthax.impl.Shit;
import com.srcgod.shittthax.api.clickgui.component.Component;
import com.srcgod.shittthax.api.clickgui.component.Frame;
import com.srcgod.shittthax.api.clickgui.component.components.sub.Checkbox;
import com.srcgod.shittthax.api.clickgui.component.components.sub.Keybind;
import net.minecraft.client.Minecraft;
import net.minecraft.client.gui.FontRenderer;
import net.minecraft.client.gui.Gui;
import com.srcgod.shittthax.api.clickgui.component.components.sub.ModeButton;
...
public class Button extends Component {
	...
	public Button(Module mod, Frame parent, int offset) {
		...
		this.open = false;
		int opY = offset + 12;
		if(Shit.instance.settingsManager.getSettingsByMod(mod) != null) {
			for(Setting s : Shit.instance.settingsManager.getSettingsByMod(mod)){
				if(s.isCombo()){
