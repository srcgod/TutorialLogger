package com.srcgod.shittthax.impl.modules.combat;
...
public class KillAura extends Module {
        public KillAura() {
            ...
            Shit.instance.settingsManager.rSetting(new Setting("Range", this, 4.2, 1, 5, false));
            Shit.instance.settingsManager.rSetting(new Setting("OnlyCritical", this, false));
        }
        ...
        public void onUpdate(RenderWorldLastEvent e) {
            ...
            boolean onlyCrits = Shit.instance.settingsManager.getSettingByName(this.name, "OnlyCritical").getValBoolean();
